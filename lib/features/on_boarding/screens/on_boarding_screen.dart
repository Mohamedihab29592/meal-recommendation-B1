        ...
        children: [  
          ...
          Padding(  
            ...
            child: Column(  
              ...
              children: [  
                // Circle  
                Container(  
                  margin: EdgeInsets.only(bottom: 60.h), // Use ScreenUtil's h for margin  
                  height: 320.h, // Height corresponds to h for responsive height  
                ...
                Row(  
                  ...
                  children: [  
                    ...
                    TextButton(  
                      ...
                      child: Text(  
                        "Skip",  
                        style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15.sp, color: AppColors.primary),  
                      ),  
                    ),  
                    // Points  
                    Row(  
          ...
          Container(  
            ...
            decoration: BoxDecoration(  
              ...
              borderRadius: BorderRadius.only(bottomLeft: Radius.circular(350.r), bottomRight: Radius.circular(350.r)),  
            ),  
          ),  
